...
<html lang="en">
  <head>
    ...
    <title>Bintang Rasa &mdash; E-Catering </title>
    <!-- plugins:css -->
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <center><img src="{{ asset('shopper') }}/images/catering.svg"></center>
                </div>
                <h4>Haloo, pelanggan!</h4>
                <h6 class="font-weight-light">Silahkan Daftar</h6>
                ...
                @enderror
                  ...
                  <div class="mt-3"> </br>
                    ...
                    <div className="google-btn">
                      <div className="google-icon-wrapper">
                        <a href="login/google">
                          <center><img className="google-icon" src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg" alt="google button" />&nbsp;<b>&nbsp;&nbsp;DAFTAR DENGAN GOOGLE</b></center>
                        </a>
                      </div>
                  ...
                  <div class="text-center mt-4 font-weight-light"> Sudah punya akun? <a href="login.html" class="text-primary">Masuk</a>
                  </div>
                </form>
              </div>
            </div>
